...
class WxMongo(object):
    ...
    def start(self):
        ...
        self.db = mongodb.WxDatabase(self.conn, conf.db_name)
        ...
        print conf.dc_record, conf.dc
        self.dc_record = discount.DiscountRecord(self.db.get_collection(conf.dc_record))
        self.dc = discount.Discount(self.db.get_collection(conf.dc))
